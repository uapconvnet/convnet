...
// Scalar
void * memset_8bit(void *dest, uint8_t val, size_t len); // 1 byte
...
// Scalar
void * memmove_8bit(void *dest, const void *src, size_t len); // 1 byte
...
// Scalar
void * memcpy_8bit(void *dest, const void *src, size_t len); // 1 byte
...
// Scalar
int memcmp_8bit (const void *str1, const void *str2, size_t count);

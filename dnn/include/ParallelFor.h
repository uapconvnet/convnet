...
namespace dnn
{
	...
	template <typename Func>
	inline void for_i_activation(const size_t range, const size_t threads, const Func& f)
	{
...
#pragma omp parallel for schedule(static,chunk) num_threads(thrds)
	...
	template <typename Func>
	inline void for_i_add(const size_t range, const size_t threads, const Func& f)
	{
		if (std::min(range, threads) > 1)
		{
#if DNNL_CPU_RUNTIME == DNNL_RUNTIME_OMP
...
#pragma omp parallel for schedule(static,chunk) num_threads(thrds)
	...
	template <typename Func>
	inline void for_i_average(const size_t range, const size_t threads, const Func& f)
	{
		if (std::min(range, threads) > 1)
		{
#if DNNL_CPU_RUNTIME == DNNL_RUNTIME_OMP
...
#pragma omp parallel for schedule(static,chunk) num_threads(thrds)
	...
	template <typename Func>
	inline void for_i_batchnorm(const size_t range, const size_t threads, const Func& f)
	{
		if (std::min(range, threads) > 1)
		{
#if DNNL_CPU_RUNTIME == DNNL_RUNTIME_OMP
...
#pragma omp parallel for schedule(static,chunk) num_threads(thrds)
	...
	template <typename Func>
	inline void for_i_splt(const size_t range, const size_t threads, const Func& f)
	{
		if (std::min(range, threads) > 1)
		{
#if DNNL_CPU_RUNTIME == DNNL_RUNTIME_OMP

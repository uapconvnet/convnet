...
using ToolBarControls.Avalonia.Demo.ViewModels.Items;
using ToolBarViewModel = ToolBarControls.Avalonia.Demo.ViewModels.ToolBars.ToolBarViewModel;

namespace ToolBarControls.Avalonia.Demo.Helpers;
...
public static class ControlHelper
{
    ...
    public static ToolBar CreateToolBar(int number, int band, int bandIndex, bool viewModeled = false)
    {
        return new ToolBar
        {

...
namespace Convnet.Common
{
    public class ScriptEditor : TextEditor, INotifyPropertyChanged
    {
        ...
        public ScriptEditor()
        {
            ...
            //LostFocus += ScriptEditor_LostFocus;
        }

        //private void ScriptEditor_LostFocus(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
        //{
        //    Code = base.Text;
        ...
        public static readonly DirectProperty<ScriptEditor, string> CodeProperty = AvaloniaProperty.RegisterDirect<ScriptEditor, string>(
            nameof(Code),
            o => o.Code,
            (o, v) =>
            {
